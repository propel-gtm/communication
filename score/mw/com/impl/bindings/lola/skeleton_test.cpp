...
class SkeletonTestMockedSharedMemoryFixture : public SkeletonMockedMemoryFixture
{
  protected:
    ...
    SkeletonServiceDataControlLocal existing_service_data_control_qm_local_{existing_service_data_control_qm_};
    SkeletonServiceDataControlLocal existing_service_data_control_b_local_{existing_service_data_control_b_};
