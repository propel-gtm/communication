...
EventDataControlComposite<AtomicIndirectorType>::EventDataControlComposite(
    SkeletonEventDataControlLocal<>& asil_qm_control_local,
    ...
    -> ControlSlotCompositeIndicator
{
    ...
    SkeletonEventDataControlLocal<>::LocalEventControlSlots::iterator qm_slot_ptr{};
    SkeletonEventDataControlLocal<>::LocalEventControlSlots::iterator asil_b_slot_ptr{};
...
template <template <class> class AtomicIndirectorType>
SkeletonEventDataControlLocal<>& EventDataControlComposite<AtomicIndirectorType>::GetQmEventDataControlLocal()
    const noexcept
{
...
EventSlotStatus::EventTimeStamp EventDataControlComposite<AtomicIndirectorType>::GetLatestTimestamp() const noexcept
{
    ...
    SkeletonEventDataControlLocal<>& control =
