...
class TransactionLogRegistrationGuard
{
  public:
    ...
    /// \return
    static score::Result<TransactionLogRegistrationGuard> Create(ProxyEventDataControlLocal<>& event_data_control_local,
    ...
    /// \return
    static TransactionLogRegistrationGuard Create(SkeletonEventDataControlLocal<>& event_data_control_local) noexcept;
