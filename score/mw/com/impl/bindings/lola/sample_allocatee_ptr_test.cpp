...
class SampleAllocateePtrFixture : public ::testing::Test
{
  public:
    ...
    SkeletonEventDataControlLocal<> skeleton_event_data_control_local_{control_block_};
    EventDataControlComposite<> control_composite_{&skeleton_event_data_control_local_};
};
