...
class EventDataControlCompositeFixture : public ::testing::Test
{
  public:
    ...
    std::optional<SkeletonEventDataControlLocal<>> skeleton_qm_local_{};
    std::optional<SkeletonEventDataControlLocal<>> skeleton_asil_local_{};
    std::optional<ProxyEventDataControlLocal<>> proxy_qm_local_{};
    std::optional<ProxyEventDataControlLocal<>> proxy_asil_local_{};
...
TEST(EventDataControlCompositeTest, DISABLED_fuzz)
{
    ...
    auto receiver = [&last_send_time_stamp, &qm, &asil]() {
        ProxyEventDataControlLocal proxy_asil_local{asil};
        ProxyEventDataControlLocal proxy_qm_local{qm};
