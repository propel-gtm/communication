...
SkeletonEventDataControlLocal<AtomicIndirectorType>::SkeletonEventDataControlLocal(
...
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::AllocateNextSlot() noexcept -> ControlSlotIndicator
{
...
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::FindOldestUnusedSlot() noexcept -> ControlSlotIndicator
{
...
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::EventReady(
...
template <template <class> class AtomicIndirectorType>
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::Discard(ControlSlotIndicator slot_indicator) -> void
{
    SCORE_LANGUAGE_FUTURECPP_ASSERT_PRD(slot_indicator.IsValid());
...
// segmentation fault which leds to calling std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::ReferenceSpecificEvent(
...
// segmentation fault which leds to calling std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
void SkeletonEventDataControlLocal<AtomicIndirectorType>::DereferenceEventWithoutTransactionLogging(
...
// segmentation fault which leds to calling std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::operator[](const SlotIndexType slot_index) const noexcept
    -> EventSlotStatus
{
    SCORE_LANGUAGE_FUTURECPP_ASSERT_PRD(static_cast<std::size_t>(slot_index) < state_slots_.size());
...
// implicitly". This is a false positive, no way for throwing std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::RemoveAllocationsForWriting() noexcept -> void
{
...
template <template <class> class AtomicIndirectorType>
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::DumpPerformanceCounters() -> void
{
...
template <template <class> class AtomicIndirectorType>
auto SkeletonEventDataControlLocal<AtomicIndirectorType>::ResetPerformanceCounters() -> void
{
...
template class SkeletonEventDataControlLocal<memory::shared::AtomicIndirectorReal>;
template class SkeletonEventDataControlLocal<memory::shared::AtomicIndirectorMock>;
