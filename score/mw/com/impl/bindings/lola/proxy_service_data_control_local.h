 ...
 ********************************************************************************/
#ifndef SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_PROXY_SERVICE_DATA_CONTROL_LOCAL_H
#define SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_PROXY_SERVICE_DATA_CONTROL_LOCAL_H

#include "score/mw/com/impl/bindings/lola/application_id_pid_mapping.h"
#include "score/mw/com/impl/bindings/lola/element_fq_id.h"
#include "score/mw/com/impl/bindings/lola/proxy_event_control_local.h"
...
/// ProxyServiceDataControlLocal is a view class which stores views to the individual objects in shared memory.
///
...
/// ProxyServiceDataControlLocal to avoid accessing the shared memory via OffsetPtr. Additional information about the
/// performance impacts of OffsetPtr are described in EventDataControl.
class ProxyServiceDataControlLocal
{
  public:
    explicit ProxyServiceDataControlLocal(ServiceDataControl& service_data_control)
    ...
    ~ProxyServiceDataControlLocal() noexcept = default;

    ProxyServiceDataControlLocal(const ProxyServiceDataControlLocal&) = delete;
    ProxyServiceDataControlLocal& operator=(const ProxyServiceDataControlLocal&) = delete;
    ProxyServiceDataControlLocal(ProxyServiceDataControlLocal&&) noexcept = delete;
    ProxyServiceDataControlLocal& operator=(ProxyServiceDataControlLocal&& other) noexcept = delete;
    ...
    score::memory::shared::Map<ElementFqId, ProxyEventControlLocal> event_controls_;
...
#endif  // SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_PROXY_SERVICE_DATA_CONTROL_LOCAL_H
