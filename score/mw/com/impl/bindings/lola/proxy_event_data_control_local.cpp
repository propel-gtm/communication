...
ProxyEventDataControlLocal<AtomicIndirectorType>::ProxyEventDataControlLocal(
...
auto ProxyEventDataControlLocal<AtomicIndirectorType>::ReferenceNextEvent(
...
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto ProxyEventDataControlLocal<AtomicIndirectorType>::ReferenceSpecificEvent(
...
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
std::size_t ProxyEventDataControlLocal<AtomicIndirectorType>::GetNumNewEvents(
...
template <template <class> class AtomicIndirectorType>
auto ProxyEventDataControlLocal<AtomicIndirectorType>::DereferenceEvent(
...
// segmentation fault which leds to calling std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
void ProxyEventDataControlLocal<AtomicIndirectorType>::DereferenceEventWithoutTransactionLogging(
...
// segmentation fault which leds to calling std::terminate().
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
auto ProxyEventDataControlLocal<AtomicIndirectorType>::operator[](const SlotIndexType slot_index) const noexcept
    -> EventSlotStatus
{
    SCORE_LANGUAGE_FUTURECPP_ASSERT_PRD(static_cast<std::size_t>(slot_index) < state_slots_.size());
...
template <template <class> class AtomicIndirectorType>
auto ProxyEventDataControlLocal<AtomicIndirectorType>::DumpPerformanceCounters() -> void
{
...
template <template <class> class AtomicIndirectorType>
auto ProxyEventDataControlLocal<AtomicIndirectorType>::ResetPerformanceCounters() -> void
{
...
template class ProxyEventDataControlLocal<memory::shared::AtomicIndirectorReal>;
template class ProxyEventDataControlLocal<memory::shared::AtomicIndirectorMock>;
