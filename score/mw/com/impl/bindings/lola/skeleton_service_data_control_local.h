 ...
 ********************************************************************************/
#ifndef SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_SERVICE_DATA_CONTROL_LOCAL_H
#define SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_SERVICE_DATA_CONTROL_LOCAL_H
...
/// SkeletonServiceDataControlLocal is a view class which stores views to the individual objects in shared memory.
///
...
class SkeletonServiceDataControlLocal
{
  public:
    ...
    ~SkeletonServiceDataControlLocal() noexcept = default;

    SkeletonServiceDataControlLocal(const SkeletonServiceDataControlLocal&) = delete;
    SkeletonServiceDataControlLocal& operator=(const SkeletonServiceDataControlLocal&) = delete;
    SkeletonServiceDataControlLocal(SkeletonServiceDataControlLocal&&) noexcept = delete;
    SkeletonServiceDataControlLocal& operator=(SkeletonServiceDataControlLocal&& other) noexcept = delete;
...
#endif  // SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_SERVICE_DATA_CONTROL_LOCAL_H
