 ...
 ********************************************************************************/
#ifndef SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_CONTROL_LOCAL_H
#define SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_CONTROL_LOCAL_H
...
class SkeletonEventControlLocal
{
  public:
    using SubscriberCountType = EventSubscriptionControl::SubscriberCountType;
    SkeletonEventControlLocal(EventControl& event_control_shared_mem) noexcept;
...
#endif  // SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_CONTROL_LOCAL_H
