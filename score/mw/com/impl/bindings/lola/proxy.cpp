...
ProxyServiceDataControlLocal GetProxyServiceDataControlLocal(
    const memory::shared::ManagedMemoryResource& control) noexcept
{
    ...
    return ProxyServiceDataControlLocal{*service_data_control};
}
                                              ...
                                              const memory::shared::ManagedMemoryResource& data) noexcept
{
    ...
    auto service_data_control_local = GetProxyServiceDataControlLocal(control);
...
Proxy::Proxy(std::shared_ptr<memory::shared::ManagedMemoryResource> control,
    ...
    : ProxyBinding{},
      ...
      service_data_control_local_{GetProxyServiceDataControlLocal(*control_)},
...
// exception.
// coverity[autosar_cpp14_a15_5_3_violation : FALSE]
ProxyEventControlLocal& Proxy::GetEventControlLocal(const ElementFqId element_fq_id) noexcept
{
