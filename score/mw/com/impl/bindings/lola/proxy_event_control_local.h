 ...
 ********************************************************************************/
#ifndef SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_PROXY_EVENT_CONTROL_LOCAL_H
#define SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_PROXY_EVENT_CONTROL_LOCAL_H
...
class ProxyEventControlLocal
{
  public:
    using SubscriberCountType = EventSubscriptionControl::SubscriberCountType;
    ProxyEventControlLocal(EventControl& event_control_shared_mem) noexcept;
    ...
    ProxyEventDataControlLocal<> data_control;
    // coverity[autosar_cpp14_m11_0_1_violation]
...
#endif  // SCORE_AAS_MW_COM_IMPL_BINDINGS_LOLA_PROXY_EVENT_CONTROL_LOCAL_H
