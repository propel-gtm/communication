 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_DATA_CONTROL_LOCAL_H
#define SCORE_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_DATA_CONTROL_LOCAL_H
...
// #include "score/mw/com/impl/bindings/lola/transaction_log_view.h"
...
class SkeletonEventDataControlLocal final
{
  ...
  public:
    ...
    SkeletonEventDataControlLocal(EventDataControl& event_data_control) noexcept;

    ~SkeletonEventDataControlLocal() noexcept = default;

    SkeletonEventDataControlLocal(const SkeletonEventDataControlLocal&) = delete;
    SkeletonEventDataControlLocal& operator=(const SkeletonEventDataControlLocal&) = delete;
    SkeletonEventDataControlLocal(SkeletonEventDataControlLocal&&) noexcept = delete;
    SkeletonEventDataControlLocal& operator=(SkeletonEventDataControlLocal&& other) noexcept = delete;
...
#endif  // SCORE_MW_COM_IMPL_BINDINGS_LOLA_SKELETON_EVENT_DATA_CONTROL_LOCAL_H
