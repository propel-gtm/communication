 ...
 ********************************************************************************/
#ifndef SCORE_MW_COM_IMPL_BINDINGS_LOLA_PROXY_EVENT_DATA_CONTROL_LOCAL_H
#define SCORE_MW_COM_IMPL_BINDINGS_LOLA_PROXY_EVENT_DATA_CONTROL_LOCAL_H
...
// #include "score/lib/memory/shared/memory_resource_proxy.h"
// #include "score/lib/memory/shared/polymorphic_offset_ptr_allocator.h"
...
class ProxyEventDataControlLocal final
{
    ...
    // template <template <class> class AtomicIndirectorTypeOther>
    // friend class ProxyEventDataControlLocal;
  ...
  public:
    ...
    ProxyEventDataControlLocal(EventDataControl& event_data_control_shared) noexcept;

    ~ProxyEventDataControlLocal() noexcept = default;

    ProxyEventDataControlLocal(const ProxyEventDataControlLocal&) = delete;
    ProxyEventDataControlLocal& operator=(const ProxyEventDataControlLocal&) = delete;
    ProxyEventDataControlLocal(ProxyEventDataControlLocal&&) noexcept = delete;
    ProxyEventDataControlLocal& operator=(ProxyEventDataControlLocal&& other) noexcept = delete;
  ...
  private:
    ...
    /// gtodo: Check that all variables are needed on both proxy and skeleton side.
...
#endif  // SCORE_MW_COM_IMPL_BINDINGS_LOLA_PROXY_EVENT_DATA_CONTROL_LOCAL_H
