...
#include "score/lib/containers/dynamic_array.h"
#include "score/mw/com/impl/bindings/lola/event_slot_status.h"
#include "score/mw/com/impl/bindings/lola/test_doubles/fake_memory_resource.h"
#include "score/mw/com/impl/instance_specifier.h"

#include "score/lib/memory/shared/atomic_indirector.h"
#include "score/lib/memory/shared/atomic_mock.h"
...
/// gtodo: Update tests. Either (1) just add ProxyEventDataControlLocal / SKeletonEventDataControlLocal to these tests
/// where needed and have single test file. Or (2) split them up into proxy_event_data_control_local_test.cpp /
/// skeleton...
...
//     std::unique_ptr<detail_event_data_control::EventDataControlImpl<memory::shared::AtomicIndirectorMock>>
//     unit_mock_{
//         nullptr};
//
...
//         })
//         // ... first slot was set to in-writing by a different party at the last possible time right before we check
//         in
//         // AllocateNextSlot()
//         .WillOnce([] {
...
//         })
//         // ... first slot keeps in-writing status during next iteration in FindOldestUnusedSlot() and therefore won't
//         be
//         // chosen
//         .WillOnce([] {
//             EventSlotStatus event_slot_status_in_writing{};
...
// }
//
// // Test is timing out in the CI likely due to a race condition. Test to be investigated and re-enabled in SWP-206121.
...
//     unit.GetTransactionLogSet().RegisterProxyElement(kDummyTransactionLogId);
//
...
// }
//
// // Re-enable when the test is fixed in SWP-128552
...
//     EXPECT_CALL(atomic_mock, compare_exchange_weak(_, _,
//     _)).Times(max_reference_retries).WillRepeatedly(Return(false));
//
...
// {
//     // this test case increases the contention between reader and writer, by ensuring that the reader will hold his
//     max.
