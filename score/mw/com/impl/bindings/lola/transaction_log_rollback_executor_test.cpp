...
class TransactionLogRollbackExecutorFixture : public ::testing::Test
{
  protected:
    ...
    ProxyEventDataControlLocal<>& GetProxyEventDataControlLocal(const ElementFqId element_fq_id) noexcept
    {
    ...
    {
        auto& proxy_event_data_control_local = GetProxyEventDataControlLocal(element_fq_id);
    ...
    std::optional<ProxyServiceDataControlLocal> proxy_service_data_control_local_{};
